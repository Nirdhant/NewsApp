...
fun ConvertToBadge(text: String){
    Badge(modifier = Modifier.padding(4.dp),contentColor = MaterialTheme.colorScheme.onTertiaryContainer,containerColor = MaterialTheme.colorScheme.tertiaryContainer){
