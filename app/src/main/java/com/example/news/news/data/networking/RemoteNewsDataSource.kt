package com.example.news.news.data.networking

import com.example.news.core.data.networking.UrlConstructor
import com.example.news.core.data.networking.safeCall
import com.example.news.core.domain.util.NetworkErrors
import com.example.news.core.domain.util.Result
import com.example.news.core.domain.util.map
import com.example.news.news.data.dto.NewsResponseDto
import com.example.news.news.data.mapper.toNews
