...
fun HomeLazyColumn(
    ...
    PullToRefreshBox(
        ...
        onRefresh = { newsViewModel.loadNews(isRefresh = true) },
        ...
        modifier = Modifier.fillMaxSize(),
         indicator = {
            Indicator(
                ...
                threshold = PullToRefreshDefaults.PositionalThreshold + WindowInsets.safeDrawing.asPaddingValues().calculateTopPadding()
            )
        }) {
        ...
        LazyColumn(
            state = lazyListState,
            modifier = Modifier
                .navigationBarsPadding().statusBarsPadding().displayCutoutPadding()
                .fillMaxSize(),
